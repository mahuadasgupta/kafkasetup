...
// example:kafka-topics.sh --create --zookeeper localhost:2181 --replication-factor 1  --partitions 1 --topic Topicname
...
//Execute on a terminal:java -cp "/opt/app/kafka_2.12-0.0/lib/*":. Producer Topicname
